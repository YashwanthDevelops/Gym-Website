				...
				if ( 'yes' === sectionData['crafto_ent_anim_item_by_item'] && elementType === 'widget' ) {
					$( '.elementor-element-' + commonId + '.elementor-widget' ).each( function() {
						...
						if ( widgetName ) {
							...
							if ( widgetName === 'crafto-service-box' ) {
								el_entrance_anime_collect += '"targets": "' + target_id +' > .elementor-widget-container > .crafto-service-box > .crafto-service-header,' + target_id +' > .elementor-widget-container > .crafto-service-box > .crafto-service-content > .crafto-service-item"' + ',';
							}
						}
					});
				}
